	...
	<form action="/plats/modifier" method="post"
		...
		<div class="form-group">
			<label for="nomPlat">Nom du plat</label> <input
				class="form-control" id="nomPlat" type="text" name="nom" value="<% out.println(request.getAttribute("nom")); %>">
		</div>
		<div class="form-group">
			<label for="prix">Prix</label> <input
				class="form-control" id="prix" type="text" name="prixPlat" value="<% out.println(request.getAttribute("prix")); %>">
		</div>
		<div class="form-group">
