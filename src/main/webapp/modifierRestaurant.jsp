...
<body>
	...
	<br />
	<h2 style="width: 50%; margin: auto; text-align: center;">Modifier un
		restaurant !</h2>
	<br />
	<form action="/restaurants/modifier" method="post"
		style="width: 60%; margin: auto">
		<div class="form-group">
			<label for="nomResto">Nom du restaurant</label> <input
				class="form-control" id="nomResto" type="text" name="nom" value="<% out.println(request.getAttribute("nom")); %>">
		</div>
		<div class="form-group">
			<label for="addResto">addresse du restaurant</label> <input
				class="form-control" id="addResto" type="text" name="addresse" value="<% out.println(request.getAttribute("addresse")); %>">
		</div>
		<div class="form-group">
			<label for="typeCuisine">Type Cuisine</label> <select
				...
				<%
			    	...
			    	for (String obj : type) 
			    	{
			    		if (obj.equals(request.getAttribute("currentType")))
	    				{
